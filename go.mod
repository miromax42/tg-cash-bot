module gitlab.ozon.dev/miromaxxs/telegram-bot
...
require (
	...
	github.com/miromax42/learn-kafka v0.0.0-20221018192326-1fd6bafc15b3
...
require (
	ariga.io/atlas v0.7.1-0.20220925103247-db83ea0cd178 // indirect
